/**
 * Shopify Revenue Trend — Daily/Weekly/Monthly aggregation
 * GET /api/shopify/stats/revenue-trend
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const cacheKey = `shopify:revenue-trend:${shopId || "all"}:${granularity}:${dateFrom || "all"}:${dateTo || "all"}`;
    ...
    logger.error("[Shopify Revenue Trend] Error:", error);
