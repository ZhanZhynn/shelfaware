...
interface MarketplaceOrderStatusChartProps {
...
export default function MarketplaceOrderStatusChart({ data }: MarketplaceOrderStatusChartProps) {
  ...
  const chartDataWithTotal = chartData.map((d) => ({ ...d, total }));
