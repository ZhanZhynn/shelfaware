...
export default function ShopifySyncHistory() {
  ...
  const { data: logs, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await apiClient.shopify.getSyncLogs();
      return response.data;
    },
  });

  const columns = useMemo<ColumnDef<ShopifySyncLogRow>[]>(
    () => [
      {
        accessorKey: "status",
        header: "Status",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Shopify Sync History</h1>
      ...
      <MarketplaceDataTable
        ...
        emptyStateDescription="Sync your Shopify store to see history here"
