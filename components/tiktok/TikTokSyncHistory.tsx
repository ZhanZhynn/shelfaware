...
export default function TikTokSyncHistory() {
  ...
  const { data: logs, isLoading } = useQuery({
    queryKey: ["tiktok", "sync-logs"],
    queryFn: async () => {
      const response = await apiClient.tiktok.getSyncLogs();
      return response.data;
    },
  });

  const columns = useMemo<ColumnDef<TikTokSyncLogRow>[]>(
    () => [
      {
        accessorKey: "status",
        header: "Status",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">TikTok Sync History</h1>
      ...
      <MarketplaceDataTable
        ...
        emptyStateDescription="Sync your TikTok Shop to see history here"
