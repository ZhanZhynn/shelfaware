...
```shell
curl -X GET \
 'https://open-api.tiktokglobalshop.com/authorization/202309/shops?app_key=38abcd&sign=5361235029d141222525e303d742f9e38aea052d10896d3197ab9d6233730b8c&timestamp=1623812664' \
...
| ^^seller_type | string | CROSS_BORDER | The type of seller.<br>Possible values:<br>- CROSS_BORDER: Cross border sellers with multiple shops in different countries.<br>- LOCAL: Local sellers with only 1 shop. |
