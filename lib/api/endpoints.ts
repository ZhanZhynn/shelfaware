...
export const API_ENDPOINTS = {
  ...
  sourcing: {
    ...
    attachment: (id: string, attachmentId: string) =>
      `/sourcing/cases/${id}/attachments/${attachmentId}`,
    ...
    costSettings: "/sourcing/cost-settings",
    costScenarios: "/sourcing/cost-scenarios",
    costScenario: (id: string) => `/sourcing/cost-scenarios/${id}`,
